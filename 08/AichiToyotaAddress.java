...
public class AichiToyotaAddress implements IKadai07_5 {
    ...
    public Map<String, String> searchByAddress(String addressText){
        Map<String, String> telMap = new HashMap<>();
        for (String key: POSTALCODE_MAP.keySet()) {  //マップが持つキーのセットを取得して回す
            String value = POSTALCODE_MAP.get(key); //回ってきたキーで値を取得
    ...
    public static void main(String[] args) {
        AichiToyotaAddress test = new AichiToyotaAddress();
        Map<String, String> telMap_0 = new HashMap<>(test.searchByCode("4442802"));
        for (String key: telMap_0.keySet()) {
            String value = telMap_0.get(key);
            System.out.println("キー：" + key + " 値：" + value);
        }

        System.out.println();

        Map<String, String> telMap_1 = new HashMap<>(test.searchByAddress("東大"));
        for (String key: telMap_1.keySet()) {
            String value = telMap_1.get(key);
            System.out.println("キー：" + key + " 値：" + value);
        }

        System.out.println();

        Map<String, String> telMap_2 = new HashMap<>(test.searchByAddress("町町"));
        for (String key: telMap_2.keySet()) {
            String value = telMap_2.get(key);
            System.out.println("キー：" + key + " 値：" + value);
        }
    }
}
